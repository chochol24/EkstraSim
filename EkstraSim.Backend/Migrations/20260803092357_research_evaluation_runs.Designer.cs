...
namespace EkstraSim.Backend.Migrations
{
    ...
    [Migration("20260803092357_research_evaluation_runs")]
    partial class research_evaluation_runs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EkstraSim.Backend.Database.Entities.ModelEvaluationRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EvaluatedMatchCount")
                        .HasColumnType("int");

                    b.Property<int>("EvaluatedRoundCount")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PromotedTeamsJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TrainingLastRound")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ModelEvaluationRuns");
                });

            modelBuilder.Entity("EkstraSim.Backend.Database.Entities.ModelPrediction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ActualAwayScore")
                        .HasColumnType("int");

                    b.Property<int>("ActualHomeScore")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ExactScoreCorrect")
                        .HasColumnType("bit");

                    b.Property<bool>("ExactScoreInTopThree")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("InvolvesPromotedTeam")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("ModelEvaluationRunId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("OutcomeCorrect")
                        .HasColumnType("bit");
                    ...
                    b.Property<double>("ProbabilityOfActualOutcome")
                        .HasColumnType("float");

                    b.Property<double>("ProbabilityOfActualScore")
                        .HasColumnType("float");

                    b.Property<double>("RankedProbabilityScore")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("ModelEvaluationRunId", "MatchId");

                    b.HasIndex("ModelEvaluationRunId", "ModelName", "Round");

                    b.ToTable("ModelPredictions");
                });

            modelBuilder.Entity("EkstraSim.Backend.Database.Entities.ModelRoundMetric", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("ExactScoreTopThreeAccuracy")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("MeanProbabilityOfActualScore")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("OutcomeAccuracy")
                        .HasColumnType("float");

                    b.Property<double>("ParameterDrift")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("EkstraSim.Backend.Database.Entities.ModelPrediction", b =>
                {
                    ...
                    b.HasOne("EkstraSim.Backend.Database.Entities.ModelEvaluationRun", "ModelEvaluationRun")
                        .WithMany("Predictions")
                        .HasForeignKey("ModelEvaluationRunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Match");

                    b.Navigation("ModelEvaluationRun");
                });

            modelBuilder.Entity("EkstraSim.Backend.Database.Entities.ModelRoundMetric", b =>
                {
                    b.HasOne("EkstraSim.Backend.Database.Entities.ModelEvaluationRun", "ModelEvaluationRun")
                        .WithMany("RoundMetrics")
                        .HasForeignKey("ModelEvaluationRunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
